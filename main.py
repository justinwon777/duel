...
RED_SHIP = pygame.transform.rotate(pygame.transform.scale(RED_SHIP, (55, 40)), 270)
...
def main():
    red = pygame.Rect(WIDTH - 100 - SHIP_WIDTH, HEIGHT//2 - SHIP_HEIGHT//2, SHIP_HEIGHT, SHIP_WIDTH)
    yellow = pygame.Rect(100, HEIGHT//2 - SHIP_HEIGHT//2, SHIP_HEIGHT, SHIP_WIDTH)
    red_bullets = []
    yellow_bullets = []
    red_health = 10
    yellow_health = 10
